...
@property (nonatomic) WXPageControl *pageControl;
...
- (void)awakeFromNib
{
    ...
    _pageControl = [[WXPageControl alloc]initWithFrame:CGRectMake(0, 0, 200, 20)];
...
- (void) updateImagesLocation
{
    ...
    [_leftImageView setImageWithURL:[NSURL URLWithString:left]];
    [_middletImageView setImageWithURL:[NSURL URLWithString:middle]];
    [_rightImageView setImageWithURL:[NSURL URLWithString:right]];
}
